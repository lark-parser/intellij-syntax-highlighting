...
public class LarkAliasImpl extends ASTWrapperPsiElement implements LarkAlias {

  public LarkAliasImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LarkExpansion getExpansion() {
    return findNotNullChildByClass(LarkExpansion.class);
  }
