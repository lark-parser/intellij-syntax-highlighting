...
public class LarkDeclareStatementImpl extends ASTWrapperPsiElement implements LarkDeclareStatement {

  public LarkDeclareStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
